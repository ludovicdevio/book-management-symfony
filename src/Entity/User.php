...
/**
 * Entité User - Gestion de l'authentification et des utilisateurs
 *
 * Design Pattern : Identity (Security Pattern)
...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    /**
     * Retourne les emprunts actifs (non retournés)
     */
    ...
    /**
     * Logique métier : Vérifie si l'utilisateur peut emprunter
     */
    public function canBorrow(): bool
    {
        return $this->isActive
            && $this->getActiveLoans()->count() < $this->maxLoans;
    }

    /**
     * Logique métier : Vérifie si l'utilisateur est administrateur
     */
